...
- Added support for Irish Passport Card document capture.
...
- Fixed intermittent NFC read failures ("System resource unavailable")
- Fixed rare crash during country selection search presentation
...
- Fixed an issue where users could not input or recover the keyboard on the CAN entry screen

## [33.0.0] - 2026-03-06

### Changed

- Implemented more UI customizations for toolbar icons, camera and mic icons in permissions screen and document types icons

## [32.8.0] - 2026-02-18

### Added

- Added NFC support for new Romanian NIC

## [32.7.0] - 2025-12-09

### Changed

- Added cryptographic signing for document uploads

## [32.6.3] - 2025-12-04

### Fixed

- Fix address line & checkbox parsing for profile data
...
- Attempted to fix rare Motion crash when completing a recording
- Fixed possible Motion crash when another app has ongoing audio
...
- Use SDK theme instead of system for Lottie animations
- Fix iPad crash when a user taps on the search in the country selection screen
- Hide navigation bar in user consent screen
...
- Attempted to fix camera issues with Selfie
- Attempted to fix a rare camera crash on iOS version >= 18.4

## [32.5.1] - 2025-04-29

### Fixed

- Attempted to fix camera issues with iOS < 18.4
...
- NFC: Improved introduction for US Passports

### Fixed

- Removed incorrect warning when Studio token is used in non-Studio flows
