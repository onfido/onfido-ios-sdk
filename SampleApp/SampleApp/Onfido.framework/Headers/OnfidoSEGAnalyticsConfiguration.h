...
@protocol OnfidoSEGApplicationProtocol <NSObject>
@property (nullable, nonatomic, assign) id<UIApplicationDelegate> delegate;
- (UIBackgroundTaskIdentifier)onfido_seg_beginBackgroundTaskWithName:(nullable NSString *)taskName expirationHandler:(void (^__nullable)(void))handler;
- (void)onfido_seg_endBackgroundTask:(UIBackgroundTaskIdentifier)identifier;
@end


@interface UIApplication (OnfidoSEGApplicationProtocol) <OnfidoSEGApplicationProtocol>
@end

typedef NSMutableURLRequest *_Nonnull (^OnfidoSEGRequestFactory)(NSURL *_Nonnull);

@protocol OnfidoSEGIntegrationFactory;
@protocol OnfidoSEGCrypto;
 ...
 */
@interface OnfidoSEGAnalyticsConfiguration : NSObject
 ...
 */
@property (nonatomic, strong, nullable) OnfidoSEGRequestFactory requestFactory;
 ...
 */
@property (nonatomic, strong, nullable) NSArray<id<OnfidoSEGMiddleware>> *middlewares;

/**
 * Register a factory that can be used to create an integration.
 */
- (void)use:(id<OnfidoSEGIntegrationFactory> _Nonnull)factory;

/**
 * Leave this nil for iOS extensions, otherwise set to UIApplication.sharedApplication.
 */
@property (nonatomic, strong, nullable) id<OnfidoSEGApplicationProtocol> application;
