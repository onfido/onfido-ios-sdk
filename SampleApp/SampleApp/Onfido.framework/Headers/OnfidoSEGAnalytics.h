...
#import "OnfidoSEGAnalyticsConfiguration.h"
 ...
 */
@class OnfidoSEGAnalyticsConfiguration;


@interface OnfidoSEGAnalytics : NSObject

/**
 * Used by the analytics client to configure various options.
 */
@property (nonatomic, strong, readonly) OnfidoSEGAnalyticsConfiguration *configuration;
 ...
 */
- (instancetype)initWithConfiguration:(OnfidoSEGAnalyticsConfiguration *)configuration;
 ...
 * @param configuration The configuration used to setup the client.
 */
+ (void)setupWithConfiguration:(OnfidoSEGAnalyticsConfiguration *)configuration;
 ...
 */
- (void)identify:(NSString *_Nullable)userId traits:(ONFIDO_SERIALIZABLE_DICT _Nullable)traits options:(ONFIDO_SERIALIZABLE_DICT _Nullable)options;
- (void)identify:(NSString *_Nullable)userId traits:(ONFIDO_SERIALIZABLE_DICT _Nullable)traits;
 ...
 */
- (void)track:(NSString *)event properties:(ONFIDO_SERIALIZABLE_DICT _Nullable)properties options:(ONFIDO_SERIALIZABLE_DICT _Nullable)options;
- (void)track:(NSString *)event properties:(ONFIDO_SERIALIZABLE_DICT _Nullable)properties;
 ...
 */
- (void)screen:(NSString *)screenTitle properties:(ONFIDO_SERIALIZABLE_DICT _Nullable)properties options:(ONFIDO_SERIALIZABLE_DICT _Nullable)options;
- (void)screen:(NSString *)screenTitle properties:(ONFIDO_SERIALIZABLE_DICT _Nullable)properties;
 ...
 */
- (void)group:(NSString *)groupId traits:(ONFIDO_SERIALIZABLE_DICT _Nullable)traits options:(ONFIDO_SERIALIZABLE_DICT _Nullable)options;
- (void)group:(NSString *)groupId traits:(ONFIDO_SERIALIZABLE_DICT _Nullable)traits;
 ...
 */
- (void)alias:(NSString *)newId options:(ONFIDO_SERIALIZABLE_DICT _Nullable)options;
...
- (OnfidoSEGAnalyticsConfiguration *)configuration;
