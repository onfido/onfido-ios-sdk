...
#import "OnfidoSEGMiddleware.h"

/**
 * NSNotification name, that is posted after integrations are loaded.
 */
extern NSString *_Nonnull OnfidoSEGAnalyticsIntegrationDidStart;

@class OnfidoSEGAnalytics;


@interface OnfidoSEGIntegrationsManager : NSObject
...
@interface OnfidoSEGIntegrationsManager (OnfidoSEGMiddleware) <OnfidoSEGMiddleware>
